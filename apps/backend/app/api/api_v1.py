...
api_router.include_router(market_profiles.router, tags=["market_profiles"], prefix="/market-profiles")
api_router.include_router(mandi_directory.router, tags=["mandi_directory"], prefix="/mandi-directory")
