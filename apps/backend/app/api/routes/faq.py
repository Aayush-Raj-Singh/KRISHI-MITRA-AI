...
from app.schemas.faq import FAQCreate, FAQDB, FAQUpdate
...
async def create_faq(
    ...
    await log_audit_event(db, user.id, user.role, "faq", created["_id"], "create", record, request.client.host)
...
async def update_faq(
    ...
    await log_audit_event(db, user.id, user.role, "faq", updated["_id"], "update", updates, request.client.host)
