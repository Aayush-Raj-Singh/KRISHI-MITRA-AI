...
app = create_app(
    ...
    routers=[
        RouterSpec(router=tickets.router, prefix=f"{settings.api_v1_prefix}/tickets", tags=["tickets"]),
        RouterSpec(router=faq.router, prefix=f"{settings.api_v1_prefix}/faq", tags=["faq"]),
        RouterSpec(router=master.router, prefix=f"{settings.api_v1_prefix}/master", tags=["master"]),
