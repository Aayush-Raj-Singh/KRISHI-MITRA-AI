        ...
        styleOverrides: {
          root: {
            ...
            boxShadow: isDark
              ...
              : "0 10px 20px rgba(16, 66, 35, 0.08)",
            position: "relative",
            transition: "box-shadow 0.18s ease, border-color 0.18s ease",
            "&:hover": {
              boxShadow: isDark
                ? "0 14px 24px rgba(0, 0, 0, 0.34)"
                : "0 14px 24px rgba(16, 66, 35, 0.12)",
      ...
      MuiButton: {
        styleOverrides: {
          root: {
            ...
            letterSpacing: 0.1,
            transition:
              "box-shadow 0.18s ease, background-color 0.18s ease, border-color 0.18s ease",
            "&:hover": {
              boxShadow: isDark
                ? "0 5px 10px rgba(0, 0, 0, 0.2)"
                : "0 5px 10px rgba(20, 20, 20, 0.08)",
            },
            "&:focus-visible": {
              boxShadow: isDark
                ? "0 0 0 2px rgba(95, 209, 139, 0.45)"
                : "0 0 0 2px rgba(27, 107, 58, 0.35)",
            },
            "&.Mui-disabled": {
              boxShadow: "none",
            },
