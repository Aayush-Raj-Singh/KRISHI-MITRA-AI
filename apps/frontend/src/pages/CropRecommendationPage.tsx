...
export const CropRecommendationContent: React.FC<CropRecommendationContentProps> = ({
  embedded = false,
}) => {
  ...
  const handleLoadCached = () => {
    try {
      ...
      setCropForm(payload);
      const cached = getCachedWithMeta<CropRecommendationResponse>(
              ...
              <Stack spacing={2}>
                ...
                <Stack direction="row" spacing={2}>
                  <TextField
                    ...
                    onChange={(e) =>
                      setCropForm({ ...cropForm, temperature_c: Number(e.target.value) })
                    }
                    fullWidth
                  />
                  <TextField
                    ...
                    onChange={(e) =>
                      setCropForm({ ...cropForm, humidity_pct: Number(e.target.value) })
                    }
                    fullWidth
                  />
                </Stack>
                <TextField
                  ...
                  onChange={(e) =>
                    setCropForm({ ...cropForm, rainfall_mm: Number(e.target.value) })
                  }
                />
                <TextField
                ...
                <Stack direction="row" spacing={2}>
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      setCropForm({ ...cropForm, historical_yield: Number(e.target.value) })
                    }
                    fullWidth
                  />
                </Stack>
