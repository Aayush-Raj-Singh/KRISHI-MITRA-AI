...
export const MODERN_FARMING_GUIDES: ModernFarmingGuide[] = [
  {
    ...
    technology: ["Soil moisture sensor", "Weather API", "Mobile advisory"],
  ...
  },
  {
    ...
    method:
      "Climate-resilient spacing, mulch cover, and integrated pest scouting under protected management.",
    ...
    technology: ["Polyhouse/net-house", "IPM traps", "AI disease alert"],
    expectedYield: "4.5-6.5 t/ha",
    marketTip: "Use local mandi + eNAM trend signals before harvest planning.",
  },
  {
