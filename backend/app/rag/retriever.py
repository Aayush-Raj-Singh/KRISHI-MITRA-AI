...
class KnowledgeBaseRetriever:
    ...
    def _retrieve_opensearch_stub(self, query: str, top_k: int) -> List[RetrievedDocument]:
        # OpenSearch-ready contract:
        # In AWS deployment this method can be swapped with opensearch-py kNN semantic search.
        # Local hackathon mode reuses semantic or tf-idf ranking to keep dependency footprint manageable.
    ...
    def retrieve(self, query: str, top_k: int | None = None) -> List[RetrievedDocument]:
        ...
        # Default backend: local semantic retrieval with tf-idf fallback.
