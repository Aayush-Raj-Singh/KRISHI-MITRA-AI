...
const STATIC_TRANSLATABLE_TEXTS = [
  "Modern Farming Library",
  "250 practical modern farming guides for crop and vegetable planning.",
  "Search crop or model",
  "Category",
  "Season",
  "All",
  "Showing",
...
const boardRowSx = {
  ...
  background: "linear-gradient(180deg, rgba(255,249,239,0.98) 0%, rgba(245,235,220,0.98) 100%)",
  px: 1.2,
  py: 0.9
} as const;
...
const boardIconShellSx = {
  width: 26,
  height: 26,
  borderRadius: "50%",
  border: "1px solid rgba(121, 83, 52, 0.28)",
    ...
    <AppLayout>
      <Stack spacing={2.5}>
        <AgricultureHero
          ...
          title={tr("Modern Farming Library")}
          subtitle={tr("250 practical modern farming guides for crop and vegetable planning.")}
          ...
          <CardContent>
            ...
            >
              ...
              <FormControl size="small" sx={{ minWidth: 170 }}>
                <InputLabel>{tr("Category")}</InputLabel>
                <Select
                  label={tr("Category")}
                  value={category}
                ...
                >
                  <MenuItem value="All">{tr("All")}</MenuItem>
              ...
              <FormControl size="small" sx={{ minWidth: 130 }}>
                <InputLabel>{tr("Season")}</InputLabel>
                <Select
                  label={tr("Season")}
                  value={season}
                  onChange={(event: SelectChangeEvent<string>) => {
              ...
              <Chip color="success" variant="outlined" label={`${tr("Showing")}: ${filtered.length} / 250`} />
            </Stack>
                  ...
                  <Stack spacing={1.45}>
                    ...
                    >
                      ...
                      <Stack direction="row" spacing={1} useFlexGap flexWrap="wrap" sx={{ mt: 1 }}>
                        ...
                        <Chip size="small" variant="outlined" label={`${guide.durationDays} ${tr("days")}`} />
                        <Chip
                          size="small"
                    ...
                    >
                      ...
                      <Stack spacing={0.92}>
                        <Box sx={boardRowSx}>
                          ...
                          <Typography variant="body2" sx={{ color: "#30261e" }}>
                            {tr(guide.method)}
                          </Typography>
                        </Box>
                        ...
                        <Box sx={boardRowSx}>
                          <Stack direction="row" spacing={0.95} alignItems="flex-start">
                            ...
                            <Box>
                              ...
                              <Typography variant="body2" sx={{ color: "#30261e", fontWeight: 700, fontSize: "1.2rem" }}>
